    ...
    <body>
        <div class="container">
            <div class="home">
                ...
                <div class="giaodien">
                    <h1 style="margin-left: 15px;">Thông tin Giáo Viên</h1>
                    <hr>
                    <div class="img">
                    ...
                    <div class="danhsach">
                        ...
                        <div class="trucnang" style="width: 560px ; margin-left: -50px;">
                            <div class="lop">
                                
                                <a href="./giao_vien_Danhsachlop.php"><i class='bx bx-menu' style="margin-left: 15px;"></i><br></a>
                                <a href="./giao_vien_Danhsachlop.php">Danh Sách lớp</a>
                            </div>
                            <div class="lop">
                                
                                <a href="./giao_vien.danhsachdongtien.php" style="font-size: 11px;"><i class='bx bxs-wallet-alt' style="margin-left: 15px;"></i><br></a>
                                <a href="./giao_vien.danhsachdongtien.php" style="font-size: 11px;">Đã Đóng Tiền</a>
                            </div>
                            <div class="lop">
                                <a href="./giao_vien_chitieu.php"><i class='bx bx-history' style="margin-left: 15px;"></i><br></a>
                                <a href="./giao_vien_chitieu.php">Lịch sử chi tiêu</a>
                            </div>
                            <div class="lop">
                                <a href="./giao_vien_taikhoan.php" style="font-size: 12px;"><i class='bx bxs-user' style="margin-left: 15px;"></i><br></a>
                                <a href="./giao_vien_taikhoan.php" style="font-size: 12px;">Tài khoản sinh viên</a>
                            </div>
                        </div>
                    </div>
                </div>
