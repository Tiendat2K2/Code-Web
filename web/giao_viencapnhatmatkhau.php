...
<body>
    <div class="container">
        <div class="form-box">
            ...
            <form action="./giao_vienresetpassword.php" method="post" onsubmit="return checkPasswords();">
                <div class="input-group">
                    <div class="input-field" id="password1Field">
                        <i class='bx bxs-lock-alt'></i>
                        <input type="password" name="password1" id="password1" placeholder="Nhập mật khẩu mới" required>
                    </div>
                    <div class="input-field" id="password2Field">
                        <i class='bx bxs-lock-alt'></i>
                        <input type="password" name="password2" id="password2" placeholder="Nhập lại mật khẩu" required>
                    </div>
                </div>
                <div class="btn-field">
                    <button type="submit" id="updatePasswordBtn">Cập nhật</button>
                </div>
            </form>
        </div>
    </div>
