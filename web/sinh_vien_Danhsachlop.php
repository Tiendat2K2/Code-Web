...
if (isset($_GET['search'])) {
    ...
    $all_classes_query = "SELECT MSSV, HoTen, GioiTinh, NgaySinh, NoiSinh, DanToc, LopHoc, KhoaHoc, SDT FROM lop WHERE IDGiaovien = $teacher_id AND (MSSV LIKE '%$searchQuery%' OR HoTen LIKE '%$searchQuery%')";
} else {
    $all_classes_query = "SELECT MSSV, HoTen, GioiTinh, NgaySinh, NoiSinh, DanToc, LopHoc, KhoaHoc, SDT FROM lop WHERE IDGiaovien = $teacher_id";
}
...
while ($class_row = $all_classes_result->fetch_assoc()) {
    ...
    echo '<td>' . $class_row['GioiTinh'] . '</td>';
    echo '<td>' . $class_row['NgaySinh'] . '</td>';
    echo '<td>' . $class_row['NoiSinh'] . '</td>';
    echo '<td>' . $class_row['DanToc'] . '</td>';
    echo '<td>' . $class_row['LopHoc'] . '</td>';
    echo '<td>' . $class_row['KhoaHoc'] . '</td>';
    echo '<td>' . $class_row['SDT'] . '</td>';
